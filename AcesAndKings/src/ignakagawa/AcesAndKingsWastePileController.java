...
public class AcesAndKingsWastePileController extends SolitaireReleasedAdapter{
	...
	public AcesAndKingsWastePileController(AcesAndKings theGame, PileView waste) {
		super(theGame);
