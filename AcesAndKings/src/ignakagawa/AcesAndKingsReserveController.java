...
public class AcesAndKingsReserveController extends SolitaireReleasedAdapter{
	...
	public AcesAndKingsReserveController(AcesAndKings theGame, RowView reserve) {
		super(theGame);
	...
	public void mousePressed(MouseEvent me) {
		...
		Column reserveColumn = (Column) src.getModelElement();
		if (reserveColumn.count() == 0) {
		...
		if (w != Container.getNothingBeingDragged()) {
			System.err.println ("ReserveColumnController::mousePressed(): Unexpectedly encountered a Dragging Object during a Mouse press.");
			return;
		}
